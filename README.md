...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 980 | 🐛 87 | 🌐 Rust | 📅 2026-08-29 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,882 | 🐛 230 | 🌐 Rust | 📅 2026-09-15, but in their words, "This is very much a work in progress".
...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 465 | 🐛 26 | 🌐 Rust | 📅 2026-09-21 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 163 | 🐛 13 | 🌐 Rust | 📅 2026-09-23 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,231 | 🐛 448 | 🌐 Rust | 📅 2026-09-24 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,927 | 🐛 278 | 🌐 Rust | 📅 2026-09-08 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 48,365 | 🐛 3,416 | 🌐 Rust | 📅 2026-09-25
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,566 | 🐛 59 | 🌐 Rust | 📅 2026-09-24 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,566 | 🐛 59 | 🌐 Rust | 📅 2026-09-24, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 321 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 built using it.
...
* More complete GDAL wrapper (or pure rust alternative). [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 453 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 is an incomplete wrapper so needs work.
...
* Sparse matrix libraries ([SPRS](https://github.com/vbarrielle/sprs) ⭐ 641 | 🐛 48 | 🌐 Rust | 📅 2026-07-28 library needs some love, the basics are there but advanced linear algebra is missing)
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 6,030 | 🐛 241 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,620 | 🐛 193 | 🌐 Rust | 📅 2026-09-25 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,769 | 🐛 51 | 🌐 Starlark | 📅 2026-09-24 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
