...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 464 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 162 | 🐛 17 | 🌐 Rust | 📅 2026-09-11 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,125 | 🐛 436 | 🌐 Rust | 📅 2026-09-11 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,919 | 🐛 275 | 🌐 Rust | 📅 2026-09-08 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 48,145 | 🐛 3,428 | 🌐 Rust | 📅 2026-09-11
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,548 | 🐛 58 | 🌐 Rust | 📅 2026-09-11 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,548 | 🐛 58 | 🌐 Rust | 📅 2026-09-11, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 320 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 built using it.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 5,992 | 🐛 237 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,580 | 🐛 183 | 🌐 Rust | 📅 2026-09-11 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,743 | 🐛 51 | 🌐 Starlark | 📅 2026-09-11 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
