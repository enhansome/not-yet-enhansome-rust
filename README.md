...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 976 | 🐛 86 | 🌐 Rust | 📅 2026-07-31 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,851 | 🐛 225 | 🌐 Rust | 📅 2026-08-07, but in their words, "This is very much a work in progress".
* Some work has been done to create OpenCV bindings in [`cv-rs`](https://github.com/nebgnahz/cv-rs) ⭐ 204 | 🐛 19 | 🌐 Rust | 📅 2021-06-13 as well as automatically generating bindings like [`opencv-rust`](https://github.com/kali/opencv-rust/) ⭐ 2,477 | 🐛 16 | 🌐 Rust | 📅 2026-07-31. Neither are very complete.

## Data processing

* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 463 | 🐛 26 | 🌐 Rust | 📅 2026-08-11 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 161 | 🐛 11 | 🌐 Rust | 📅 2026-08-07 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 32,923 | 🐛 417 | 🌐 Rust | 📅 2026-08-11 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,897 | 🐛 271 | 🌐 Rust | 📅 2026-08-11 may be interesting components to use when building this.
  * [RxRust](https://github.com/ReactiveX/RxRust) ⭐ 497 | 🐛 3 | 🌐 Rust | 📅 2015-01-30 is an older attempt to implement this according to the [reactive streams](http://www.reactive-streams.org/#the-problem) model -- it currently seems closest to this use case.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 47,629 | 🐛 3,390 | 🌐 Rust | 📅 2026-08-14
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,503 | 🐛 60 | 🌐 Rust | 📅 2026-08-14 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,503 | 🐛 60 | 🌐 Rust | 📅 2026-08-14, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 322 | 🐛 10 | 🌐 Rust | 📅 2026-08-11 built using it.
...
* More complete GDAL wrapper (or pure rust alternative). [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 447 | 🐛 62 | 🌐 Rust | 📅 2026-07-06 is an incomplete wrapper so needs work.
...
* Sparse matrix libraries ([SPRS](https://github.com/vbarrielle/sprs) ⭐ 629 | 🐛 47 | 🌐 Rust | 📅 2026-07-28 library needs some love, the basics are there but advanced linear algebra is missing)
...
* ~~[AMQP 1.0](https://www.amqp.org/resources/specifications) - While there are several libraries for AMQP 0.9.1, the AMQP 1.0 spec represents a significant departure from the previous version.~~ [`fe2o3-amqp`](https://github.com/minghuaw/fe2o3-amqp) ⭐ 90 | 🐛 35 | 🌐 Rust | 📅 2026-08-13 implements the AMQP 1.0 protocol for both client side and server/listener side.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 5,903 | 🐛 235 | 🌐 Python | 📅 2026-05-18 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,499 | 🐛 178 | 🌐 Rust | 📅 2026-08-13 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,686 | 🐛 51 | 🌐 Starlark | 📅 2026-08-14 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
