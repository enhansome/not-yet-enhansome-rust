...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 980 | 🐛 87 | 🌐 Rust | 📅 2026-08-29 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,877 | 🐛 230 | 🌐 Rust | 📅 2026-09-15, but in their words, "This is very much a work in progress".
...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 464 | 🐛 27 | 🌐 Rust | 📅 2026-09-14 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 163 | 🐛 19 | 🌐 Rust | 📅 2026-09-18 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,186 | 🐛 447 | 🌐 Rust | 📅 2026-09-18 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,924 | 🐛 275 | 🌐 Rust | 📅 2026-09-08 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 48,290 | 🐛 3,426 | 🌐 Rust | 📅 2026-09-19
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,559 | 🐛 58 | 🌐 Rust | 📅 2026-09-19 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,559 | 🐛 58 | 🌐 Rust | 📅 2026-09-19, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 320 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 built using it.
...
* More complete GDAL wrapper (or pure rust alternative). [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 452 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 is an incomplete wrapper so needs work.
...
* ~~[AMQP 1.0](https://www.amqp.org/resources/specifications) - While there are several libraries for AMQP 0.9.1, the AMQP 1.0 spec represents a significant departure from the previous version.~~ [`fe2o3-amqp`](https://github.com/minghuaw/fe2o3-amqp) ⭐ 94 | 🐛 37 | 🌐 Rust | 📅 2026-09-13 implements the AMQP 1.0 protocol for both client side and server/listener side.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 6,015 | 🐛 238 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,599 | 🐛 190 | 🌐 Rust | 📅 2026-09-20 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,766 | 🐛 51 | 🌐 Starlark | 📅 2026-09-19 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
