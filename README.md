...
* Some work has been done to create OpenCV bindings in [`cv-rs`](https://github.com/nebgnahz/cv-rs) ⭐ 204 | 🐛 19 | 🌐 Rust | 📅 2021-06-13 as well as automatically generating bindings like [`opencv-rust`](https://github.com/kali/opencv-rust/) ⭐ 2,484 | 🐛 17 | 🌐 Rust | 📅 2026-07-31. Neither are very complete.
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,033 | 🐛 447 | 🌐 Rust | 📅 2026-08-27 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,909 | 🐛 274 | 🌐 Rust | 📅 2026-08-11 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 47,950 | 🐛 3,454 | 🌐 Rust | 📅 2026-08-28
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,530 | 🐛 59 | 🌐 Rust | 📅 2026-08-29 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,530 | 🐛 59 | 🌐 Rust | 📅 2026-08-29, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 320 | 🐛 10 | 🌐 Rust | 📅 2026-08-27 built using it.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,539 | 🐛 178 | 🌐 Rust | 📅 2026-08-29 seems to be a step in the right direction -- it just needs some love!
