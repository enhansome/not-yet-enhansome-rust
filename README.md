...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 981 | 🐛 87 | 🌐 Rust | 📅 2026-08-29 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,879 | 🐛 230 | 🌐 Rust | 📅 2026-09-15, but in their words, "This is very much a work in progress".
...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 465 | 🐛 27 | 🌐 Rust | 📅 2026-09-14 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 163 | 🐛 19 | 🌐 Rust | 📅 2026-09-18 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,196 | 🐛 447 | 🌐 Rust | 📅 2026-09-18 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,927 | 🐛 277 | 🌐 Rust | 📅 2026-09-08 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 48,308 | 🐛 3,421 | 🌐 Rust | 📅 2026-09-21
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,560 | 🐛 58 | 🌐 Rust | 📅 2026-09-20 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,560 | 🐛 58 | 🌐 Rust | 📅 2026-09-20, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 321 | 🐛 10 | 🌐 Rust | 📅 2026-09-08 built using it.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 6,019 | 🐛 239 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,602 | 🐛 191 | 🌐 Rust | 📅 2026-09-21 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,767 | 🐛 51 | 🌐 Starlark | 📅 2026-09-21 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
