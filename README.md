...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 32,998 | 🐛 436 | 🌐 Rust | 📅 2026-08-20 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,906 | 🐛 273 | 🌐 Rust | 📅 2026-08-11 may be interesting components to use when building this.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 5,935 | 🐛 236 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,713 | 🐛 51 | 🌐 Starlark | 📅 2026-08-24 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
