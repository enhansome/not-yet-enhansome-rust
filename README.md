...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 975 | 🐛 86 | 🌐 Rust | 📅 2026-07-31 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,861 | 🐛 225 | 🌐 Rust | 📅 2026-08-07, but in their words, "This is very much a work in progress".
...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 465 | 🐛 26 | 🌐 Rust | 📅 2026-08-11 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 162 | 🐛 12 | 🌐 Rust | 📅 2026-08-25 now exist!
...
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,010 | 🐛 439 | 🌐 Rust | 📅 2026-08-20 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,909 | 🐛 273 | 🌐 Rust | 📅 2026-08-11 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 47,852 | 🐛 3,416 | 🌐 Rust | 📅 2026-08-26
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,525 | 🐛 59 | 🌐 Rust | 📅 2026-08-23 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,525 | 🐛 59 | 🌐 Rust | 📅 2026-08-23, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 320 | 🐛 10 | 🌐 Rust | 📅 2026-08-11 built using it.
...
* Sparse matrix libraries ([SPRS](https://github.com/vbarrielle/sprs) ⭐ 634 | 🐛 48 | 🌐 Rust | 📅 2026-07-28 library needs some love, the basics are there but advanced linear algebra is missing)
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 5,938 | 🐛 237 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,531 | 🐛 179 | 🌐 Rust | 📅 2026-08-25 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,715 | 🐛 51 | 🌐 Starlark | 📅 2026-08-25 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
