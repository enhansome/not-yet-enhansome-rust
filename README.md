...
* Piston has [`imageproc`](https://github.com/PistonDevelopers/imageproc) ⭐ 975 | 🐛 86 | 🌐 Rust | 📅 2026-08-29 based on [`image`](https://github.com/PistonDevelopers/image) ⭐ 5,865 | 🐛 227 | 🌐 Rust | 📅 2026-08-28, but in their words, "This is very much a work in progress".
...
* ~~DDS library [wiki](https://en.wikipedia.org/wiki/Data_Distribution_Service)~~ [`jhelovuo/RustDDS`](https://github.com/jhelovuo/RustDDS) ⭐ 464 | 🐛 24 | 🌐 Rust | 📅 2026-09-03 and [`s2e-systems/dust-dds`](https://github.com/s2e-systems/dust-dds) ⭐ 162 | 🐛 18 | 🌐 Rust | 📅 2026-09-02 now exist!
* ~~[HDF5](https://en.wikipedia.org/wiki/Hierarchical_Data_Format) (see also [Wikipedia](https://support.hdfgroup.org/HDF5/) and [this Reddit post](https://www.reddit.com/r/rust/comments/7r30r3/maintained_crate_for_hdf5_bindings/))~~ A stable version of [`hdf5`](https://github.com/aldanor/hdf5-rust) ⭐ 346 | 🐛 57 | 🌐 Rust | 📅 2024-08-08 crate has been released and is now [available](https://crates.io/crates/hdf5) on crates.io.
* A good stream processing pipeline with back pressure doesn't yet exist for an asynchronous data processing pipeline
  * [`tokio`](https://github.com/tokio-rs/tokio) ⭐ 33,060 | 🐛 447 | 🌐 Rust | 📅 2026-09-03 and [`futures`](https://github.com/rust-lang-nursery/futures-rs) ⭐ 5,912 | 🐛 274 | 🌐 Rust | 📅 2026-09-01 may be interesting components to use when building this.
...
* No mature game engine written in pure Rust exists yet.
  * [Bevy](https://bevyengine.org/) is a new project built with the learnings of the Amethyst project. See the [roadmap here.](https://github.com/bevyengine/bevy/projects/1) ⭐ 48,034 | 🐛 3,439 | 🌐 Rust | 📅 2026-09-04
  * [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,540 | 🐛 59 | 🌐 Rust | 📅 2026-09-03 is a 3D + 2D game engine which includes a [full graphical editor](https://github.com/FyroxEngine/Fyrox#editor) ⭐ 9,540 | 🐛 59 | 🌐 Rust | 📅 2026-09-03, and an example [3D FPS game](https://github.com/mrDIMAS/StationIapetus) ⭐ 320 | 🐛 10 | 🌐 Rust | 📅 2026-08-27 built using it.
...
* More complete GDAL wrapper (or pure rust alternative). [rust-gdal](https://github.com/georust/rust-gdal) ⭐ 448 | 🐛 62 | 🌐 Rust | 📅 2026-07-06 is an incomplete wrapper so needs work.
...
* Sparse matrix libraries ([SPRS](https://github.com/vbarrielle/sprs) ⭐ 636 | 🐛 48 | 🌐 Rust | 📅 2026-07-28 library needs some love, the basics are there but advanced linear algebra is missing)
...
* ~~[AMQP 1.0](https://www.amqp.org/resources/specifications) - While there are several libraries for AMQP 0.9.1, the AMQP 1.0 spec represents a significant departure from the previous version.~~ [`fe2o3-amqp`](https://github.com/minghuaw/fe2o3-amqp) ⭐ 92 | 🐛 35 | 🌐 Rust | 📅 2026-08-31 implements the AMQP 1.0 protocol for both client side and server/listener side.
...
* ~~There is no pure-Rust solution for QR decoding. The only other crate that handles QR decoding is the [`quirc`](https://crates.io/crates/quirc) crate, which uses C bindings~~ -- implemented [by @Wanzenbug](https://github.com/WanzenBug/rqrr) ⭐ 84 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 and [by @piderman](https://github.com/piderman314/bardecoder) ⭐ 292 | 🐛 21 | 🌐 Rust | 📅 2024-02-13, the latter of which was announced on [Reddit](https://www.reddit.com/r/rust/comments/bk7z2x/announcing_bardecoder_a_qr_detector_and_decoder/). See [the PR](https://github.com/not-yet-awesome-rust/not-yet-awesome-rust/pull/75) ⭐ 1,422 | 🐛 28 | 📅 2024-12-16.
...
* The [`beancount` data format](https://docs.google.com/document/d/1wAMVrKIA2qtRGmoVDSUBJGmYZSygUaR0uOMW1GV3YE0/edit) has no parser or emitter libraries yet.
  * Bindings to the [Python implementation of beancount](https://github.com/beancount/beancount) ⭐ 5,965 | 🐛 238 | 🌐 Python | 📅 2026-08-23 do not yet exist.
...
* A **stable** Rust interpreter does not yet exist, which would made code exploration easier.
  * [`miri`](https://github.com/rust-lang/miri) ⭐ 6,552 | 🐛 181 | 🌐 Rust | 📅 2026-09-04 seems to be a step in the right direction -- it just needs some love!
...
* Generation of Google bindings using [`googleapis`](https://github.com/googleapis/googleapis) ⭐ 8,732 | 🐛 51 | 🌐 Starlark | 📅 2026-09-03 and gRPC would be more performant than using JSON web requests to the Google API, as with [`google-apis-rs` service](http://byron.github.io/google-apis-rs/).
